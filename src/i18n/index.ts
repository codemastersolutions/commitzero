...
const dicts: Record<Lang, Dict> = {
  en: {
    ...
    "cli.preCommitStart": "Starting pre-commit with {count} task(s)...",
    "cli.preCommitElapsed": "Elapsed: {time}",
    "cli.preCommitSummary": "Pre-commit time summary:",
    "cli.preCommitSummaryItem": "{cmd}: {time}",
    "cli.preCommitSummaryTotal": "Total pre-commit time: {time}",
  ...
  pt: {
    ...
    "cli.preCommitStart": "Iniciando execução do pre-commit com {count} tarefa(s)...",
    "cli.preCommitElapsed": "Tempo decorrido: {time}",
    "cli.preCommitSummary": "Resumo de tempo dos pre-commits:",
    "cli.preCommitSummaryItem": "{cmd}: {time}",
    "cli.preCommitSummaryTotal": "Tempo total dos pre-commits: {time}",
  ...
  es: {
    ...
    "cli.preCommitStart": "Iniciando pre-commit con {count} tarea(s)...",
    "cli.preCommitElapsed": "Tiempo transcurrido: {time}",
    "cli.preCommitSummary": "Resumen de tiempo de pre-commits:",
    "cli.preCommitSummaryItem": "{cmd}: {time}",
    "cli.preCommitSummaryTotal": "Tiempo total de pre-commits: {time}",
