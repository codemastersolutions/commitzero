...
const dicts: Record<Lang, Dict> = {
  en: {
    ...
    "cli.gitNotInitialized": "Git is not initialized in this project. Do you want to initialize it? (y/N): ",
    "cli.gitInitialized": "Git repository initialized successfully.",
    "cli.gitInitCancelled": "Git initialization cancelled.",
    "cli.gitNotInitializedError": "Git is not initialized. Use --init-git flag or run 'git init' first.",
    ...
    "cli.notProjectRoot": "This command must be run from the project root (where package.json is located).",
  ...
  pt: {
    ...
    "cli.gitNotInitialized": "Git não está inicializado neste projeto. Deseja inicializá-lo? (y/N): ",
    "cli.gitInitialized": "Repositório Git inicializado com sucesso.",
    "cli.gitInitCancelled": "Inicialização do Git cancelada.",
    "cli.gitNotInitializedError": "Git não está inicializado. Use a flag --init-git ou execute 'git init' primeiro.",
    ...
    "cli.hooksPathExistsError": "Caminho de hooks já configurado: {path}. Use --force para sobrescrever.",
    "cli.hooksInstallError": "Erro ao instalar hooks: {error}",
    "cli.notProjectRoot": "Este comando deve ser executado na raiz do projeto (onde está localizado o package.json).",
  ...
  es: {
    ...
    "cli.gitNotInitialized": "Git no está inicializado en este proyecto. ¿Desea inicializarlo? (y/N): ",
    "cli.gitInitialized": "Repositorio Git inicializado exitosamente.",
    "cli.gitInitCancelled": "Inicialización de Git cancelada.",
    "cli.gitNotInitializedError": "Git no está inicializado. Use la flag --init-git o ejecute 'git init' primero.",
    ...
    "cli.hooksPathExistsError": "Camino de hooks ya configurado: {path}. Use --force para sobrescribir.",
    "cli.hooksInstallError": "Error al instalar hooks: {error}",
    "cli.notProjectRoot": "Este comando debe ejecutarse desde la raíz del proyecto (donde está ubicado package.json).",
    "cli.allowedTypes": "Tipos permitidos: {types}",
