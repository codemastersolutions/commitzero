...
export function preCommitScript(): string {
  const lines: string[] = [
    ...
    "    pt)",
    "      echo \"CommitZero não encontrado. Instale com '$INSTALL_CMD'.\" 1>&2",
    "      echo \"Para remover manualmente este hook, remova as linhas entre '" + HOOK_HEADER + " START' e '" + HOOK_HEADER + " END' em '.git/hooks/pre-commit'.\" 1>&2",
    "      ;;",
    "    es)",
    "      echo \"CommitZero no encontrado. Instala con '$INSTALL_CMD'.\" 1>&2",
    "      echo \"Para eliminar este hook manualmente, elimina las líneas entre '" + HOOK_HEADER + " START' y '" + HOOK_HEADER + " END' en '.git/hooks/pre-commit'.\" 1>&2",
    "      ;;",
    "    *)",
    "      echo \"CommitZero not found. Install with '$INSTALL_CMD'.\" 1>&2",
    "      echo \"To remove this hook manually, delete lines between '" + HOOK_HEADER + " START' and '" + HOOK_HEADER + " END' in '.git/hooks/pre-commit'.\" 1>&2",
    "      ;;",
    "  esac",
    "  exit 0",
    "fi",
